...
All notable changes to Tapthe.ai will be documented in this file.
...
#### Client SDKs
- JavaScript SDK (`@tapthe-ai/sdk`): full REST API client with streaming, TypeScript declarations
- Python client SDK (`tapthe_ai_client`): zero-dependency stdlib client with SSE streaming
- Python agent SDK (`tapthe_ai_sdk`): decorator-based framework for writing Python agents
...
- MCP server (exposes Tapthe.ai tools via MCP protocol)
...
[0.1.0]: https://github.com/RightNow-AI/tapthe-ai/releases/tag/v0.1.0
