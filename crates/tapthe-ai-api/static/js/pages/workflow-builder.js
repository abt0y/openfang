// Tapthe.ai Visual Workflow Builder — Drag-and-drop workflow designer
'use strict';
...
function workflowBuilder() {
  return {
    ...
    async init() {
      ...
      try {
        var list = await TaptheAiAPI.get('/api/agents');
    ...
    async saveWorkflow() {
      ...
      try {
        await TaptheAiAPI.post('/api/workflows', {
          name: this.workflowName || 'untitled',
          description: this.workflowDescription || '',
          steps: steps
        });
        TaptheAiToast.success('Workflow saved!');
