...
impl ChannelAdapter for NostrAdapter {
    ...
    ) -> Result<Pin<Box<dyn Stream<Item = ChannelMessage> + Send>>, Box<dyn std::error::Error>>
    {
        ...
        info!(
            ...
            tapthe_ai_types::truncate_str(&pubkey, 16)
        );
                    ...
                    let should_reconnect = loop {
                        let msg = tokio::select! {
                            _ = relay_shutdown_rx.changed() => {
                                ...
                                // Send CLOSE
                                let close_msg = serde_json::json!(["CLOSE", "tapthe-ai-sub"]);
                                let _ = write.send(
                        ...
                        let channel_msg = ChannelMessage {
                            ...
                            sender: ChannelUser {
                                ...
                                display_name: format!(
                                    "{}...",
                                    tapthe_ai_types::truncate_str(&sender_pubkey, 8)
                                ),
                                tapthe_ai_user: None,
                            },
                            content: msg_content,
...
mod tests {
    ...
    fn test_nostr_build_subscription() {
        ...
        assert!(sub.contains("tapthe-ai-sub"));
