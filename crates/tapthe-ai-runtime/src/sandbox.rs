...
//! # Host ABI
//!
//! The host provides (in the `"tapthe-ai"` import module):
...
impl WasmSandbox {
    ...
    /// Register host function imports in the linker ("tapthe-ai" module).
...
mod tests {
    ...
    const HOST_CALL_PROXY_WAT: &str = r#"
        (module
            (import "tapthe-ai" "host_call" (func $host_call (param i32 i32) (result i64)))
