...
use base64::Engine;
use tapthe_ai_types::media::{GeneratedImage, ImageGenRequest, ImageGenResult};
use tracing::warn;
...
pub async fn generate_image(request: &ImageGenRequest) -> Result<ImageGenResult, String> {
    ...
    if request.model == tapthe_ai_types::media::ImageGenModel::DallE3 {
...
mod tests {
    use super::*;
    use tapthe_ai_types::media::ImageGenModel;
